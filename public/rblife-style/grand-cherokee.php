...
<!DOCTYPE html>
<html class="full-cherokee" lang="en">
...
<body ng-controller="AppCtrl" layout="column" ng-cloak="" class="inputdemoErrors full-cherokee loading" ng-app="MyApp">
    ...
    <div style="margin-top:90px;">
        <div class="booking disNone"><img src="images/jeep-grand-cherokee-bo.png"></div>
        <div class="col-lg-4">
        <div class="disHide"><img src="images/jeep-grand-cherokee.png"></div>
            ...
            <div>
                <md-content layout-padding="" style="background:none;">
                    <form name="projectForm" action="submit.php" method="POST">
                     ...
                     <input type="hidden" name="product" value="Jeep Grand Cherokee" >
