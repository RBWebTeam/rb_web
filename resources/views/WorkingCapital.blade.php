...
<div class="tab-content">
 ...
 <form id="WorkingCapitalCurrent">
  ...
  <h3 class="emi-cal text-center">Current Status of Loan</h3>
   ...
   <input type="text" class="form-control form-group" placeholder=" Loan Tenure"  value="1" maxlength="5" id="termloanTenur" onkeypress="return isNumberKey(event)">
   <div class="form-padding validate_id" style="color: red" ></div>
...
<div class="form-padding validate_id" style="color: red" >Please Fill All Inputs</div>
