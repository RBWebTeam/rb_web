...
<style>
      ...
      #fh5co-offcanvas {display:none !important;}
    ...
    <img src="images/express-loan-image1.jpg" class="img-responsive"/>
    </div>
    ...
    <div class="row">
        ...
        <div id="iifl">
            ...
            <section class="content">
                <h3 class="text-uppercase exp-hed">IIFL Medical Loan</h3>
        ...
        <br>
            ...
            <section class="content">
                ...
                <span class="input input--nao">
                    <input class="input__field input__field--nao" type="text" name="Parameters[MobilePhone]" id="MobilePhone" readonly onkeypress="return AllowAlphabet(event)"  />
                ...
                <span class="input input--nao">
                    <input class="input__field input__field--nao" type="text" name="Parameters[Email]" id="Email" readonly onkeypress="return AllowAlphabet(event)"  />
        ...
        <div id="Applicant_Details" style="display: none;">
            ...
            <section class="content">
                ...
                <span class="input input--nao">
                    <input class="input__field input__field--nao" type="text" name="FName" required id="FName" minlength="3" readonly onkeypress="return AllowAlphabet(event)" />
                ...
                <span class="input input--nao">
                    <input class="input__field input__field--nao" type="text" name="LName" id="LName" required readonly onkeypress="return AllowAlphabet(event)" />
                ...
                <h3 class="col-md-12 mrg-tpp">Where Can We Reach you</h3>
                    <span class="input input--nao">
                    <input class="input__field input__field--nao" type="text" name="MobileNo" id="MobileNo" onkeypress="return fnAllowNumeric(event)" maxlength="10" minlength="10" readonly required />
                ...
                <span class="input input--nao">
                    <input class="input__field input__field--nao" type="text" name="PersonalEmailID" id="PersonalEmailID" readonly required/>
        ...
        <section class="content">
            <div class="col-md-12"><h3 class="mrg-tpp">Personal Information</h3></div>
                ...
                <span class="input input--nao">
                 ...
                 <span class="input input--nao">
                    <select class="input__field input__field--nao" name="CoapplicantFlag" id="CoapplicantFlag" required>
                       <option disabled selected value=""></option>
                       <option value="1">Yes</option>
                       <option value="0">No</option>
                    </select>
                    <label class="input__label input__label--nao" for="input-3">
                    <span class="input__label-content input__label-content--nao">Is Co-applicant</span>
                    </label>
                    <svg class="graphic graphic--nao" width="300%" height="100%" viewBox="0 0 1200 60" preserveAspectRatio="none">
                    <path d="M0,56.5c0,0,298.666,0,399.333,0C448.336,56.5,513.994,46,597,46c77.327,0,135,10.5,200.999,10.5c95.996,0,402.001,0,402.001,0"/>
                    </svg>
            ...
            <!-- <div class="btn-grp mrg-top m-status emp-nat" data-toggle="buttons"><h2><b>If Co-Applicant Exist :</b></h2>
                      <span class="btn btn-primary outer-brd active"><input type="radio"  name="CoapplicantFlag" id="yes"  value="1">Yes</span>
                      <span class="btn btn-primary outer-brd"><input type="radio"  name="CoapplicantFlag" id="no" checked="" value="0" >No</span>
                </div> -->
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <h4><p style="color: black;font-size: 10px"><b>You must agree to the terms first.</b>.</p></h4>
      </div>
...
<div class="modal fade" tabindex="-1" role="dialog" id="status">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <h4><p style="color: black;font-size: 10px"><b>Reason is <span id="status_description"></span></b>.</p></h4>
      </div>
...
<div class="modal fade" tabindex="-1" role="dialog" id="prospect">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
      ...
      <div class="modal-body">
        <h4><p style="color: black;font-size: 10px"><b>Prospect Number for the particular customer is<span id="prospectNo"></span></b>.</p></h4>
      </div>
...
<div class="modal fade" tabindex="-1" role="dialog" id="re_marks">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
      ...
      <div class="modal-body">
        <h4><p style="color: black;font-size: 10px"><b>Thank You For Choosing IIFL.Your application has been rejected due to internal credit policy.Reason:<span id="remarks"></span></b>.</p></h4>
      </div>
...
<div class="modal fade" tabindex="-1" role="dialog" id="netincome">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
      ...
      <div class="modal-body">
        <h4><p style="color: black;font-size: 10px"><b>Your Net Income Should Be Greater Than 25000 OR 25000.</b></p></h4>
      </div>
...
<div class="modal fade" tabindex="-1" role="dialog" id="mobile">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
      ...
      <div class="modal-body">
        <h4><p style="color: black;font-size: 10px"><b>Contact Number Should Be Of 10 digits.</b></p></h4>
      </div>
...
<div class="modal fade" tabindex="-1" role="dialog" id="eligibile_amt">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
      ...
      <div class="modal-body">
        <h4><p style="color: black;font-size: 10px"><b>Enter amount less than or equal to eligible amount</b>.</p></h4>
      </div>
...
<div class="modal fade" tabindex="-1" role="dialog" id="req_tenure">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
      ...
      <div class="modal-body">
        <h4><p style="color: black;font-size: 10px"><b>Enter tenure less than or equal to required tenure</b>.</p></h4>
      </div>
...
<div class="modal fade" tabindex="-1" role="dialog" id="nme">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
      ...
      <div class="modal-body">
        <h4><p style="color: black;font-size: 10px"><b>First Name should be more than 3 characters</b>.</p></h4>
      </div>
...
<div class="modal fade" tabindex="-1" role="dialog" id="salary_upto_mark">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
      ...
      <div class="modal-body">
        <h4><p style="color: black;font-size: 10px"><b>Your Salary Is Not Upto Mark</b>.</p></h4>
      </div>
           ...
           $.ajax({  
            ...
            ////console.log(msg);
             ...
             if (msg.head.status != "1") {
                ...
                $('#status_description').empty().append(msg.head.status_description);
                 $('#status').modal('show');
...
<script type="text/javascript">
    ...
    function loan_eligibility(ROI,maxEmi,maxTenure,maxloanamt,minTenure,minloanamt,processingfee,offerstatus,remarks,prospectNo)
    {
          ...
          $('#prospectNo').empty().append(number);
          $('#prospect').modal('show');
