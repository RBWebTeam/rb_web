                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                   <img src="{{$Bank_Logo}}" class="img-responsive" style="align-content: center;margin: 0 auto;display: block;margin-top: 70px;" />
                                </div>
                        ...
                        <!-- <p>Easy to apply for a loan with us,Once you have complete this form. </p> -->
                         <form class="" id="compareform" role="form" method="POST">            
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" class="form-control" id="product" value="{{$product}}" name="product"  />
                            </div>
                            <!-- Text input-->
                            <div class="form-group">
...
<!--     <td><input type="checkbox" name="cehckbox"/></td> -->
  ...
  <!--  <td class="upper" width="17%"><a href="{{URL::to('apply-')}}{{$product}}">Apply Online</a></td> -->
    ...
    <td>Pre close Fee {{$value->Pre_Closer_Fixed}}%</td>
  </tr>
</table>
  <br />  
 
    
<a data-toggle="collapse" data-target="#{{$key}}" class="btn btn-default btn-sm">Know More</a> 
   ...
   <!--  <td>Intrest Paid - INR 50,000</td> -->
    ...
    <a href="{{URL::to('')}}/{{$product}}" class="btn btn-default btn-sm">Apply Online</a>
  <?php }else{ ?>
  <a href="{{URL::to('business-loan')}}" class="btn btn-default btn-sm">Apply Online</a>

  <?php } ?>
    
      
<div id="{{$key}}" class="lender-feature-list collapse">   
