...
<div id="fh5co-hero">
 ...
 <p><div>
          <input type="checkbox" name="agreement1" value="accept" checked>&nbsp; Accept&nbsp;
          <input type="checkbox" name="agreement2" value="decline">&nbsp; Decline
										...
										&nbsp;&nbsp;&nbsp;&nbsp;<button class="btn btn-primary btn-outline with-arrow animate-box fadeInUp animated" value="Get Checked" onclick ="checkButton()" >Confirm & Continue<i class="icon-arrow-right"></i>
									</button>
...
function checkButton(){
	// alert("hiee");
if(document.agreement1.checked == true){
alert("Box1 is checked");
} else if(document.agreement2.checked == true){
