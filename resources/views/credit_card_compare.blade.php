...
<div id="fh5co-hero">
  ...
  <tr class="ICICI-Card">
    ...
    <td  class="v-align"></td>
    <td class="v-align"></td>
    <td class="v-align"><a href="{{URL::to('credit-card-form?name=gemstone&card=platinum-Chip')}}"><button>Apply Online</button></a></td>
  </tr>
  ...
  <tr class="ICICI-Card">
    ...
    <td class="v-align"><a href="{{URL::to('credit-card-form?name=gemstone&card=coral-Contactless')}}"><button>Apply Online</button></a></td>
  </tr>
  ...
  <tr class="ICICI-Card">
    ...
    <td class="v-align"><a href="{{URL::to('credit-card-form?name=gemstone&card=rubyx')}}"><button>Apply Online</button></a></td>
  </tr>
  ...
  <tr class="ICICI-Card">
    ...
    <td class="v-align"><a href="{{URL::to('credit-card-form?name=gemstone&card=sapphiro')}}"><button>Apply Online</button></a></td>
  </tr>
   ...
   <tr class="ICICI-Card">
    ...
    <td class="v-align">Rs.1250 + ST</td>
    <td class="v-align"><a href="{{URL::to('credit-card-form?name=jet&card=coral')}}"><button>Apply Online</button></a></td>
  </tr>
  ...
  <tr class="ICICI-Card">
    ...
    <td class="v-align">Rs. 2500 + ST</td>
    <td class="v-align"><a href="{{URL::to('credit-card-form?name=jet&card=rubyx')}}"><button>Apply Online</button></a></td>
  </tr>
  <tr class="ICICI-Card">
    <td class="dis-non"><input type="checkbox" name="cehckbox"/> <button style="display:none;" data-toggle="collapse" data-target="#5" aria-expanded="true">Details </button></td>
    ...
    <td class="v-align">Rs.5000 + ST</td>
    <td class="v-align"><a href="{{URL::to('credit-card-form?name=jet&card=sapphiro')}}"><button>Apply Online</button></a></td>
  </tr>
  ...
  <tr class="ICICI-Card">
   ...
   <tr class="ICICI-Card">
    ...
    <td class="v-align"><a href="{{URL::to('credit-card-form?name=ferrari &card=platinum')}}"><button>Apply Online</button></a></td>
  </tr>
  <tr class="ICICI-Card">
    <td class="dis-non"><input type="checkbox" name="cehckbox"/> <button style="display:none;" data-toggle="collapse" data-target="#5" aria-expanded="true">Details </button></td>
    ...
    <td class="v-align"><a href="{{URL::to('credit-card-form?name=ferrari &card=signature')}}"><button>Apply Online</button></a></td>
  </tr>
