                    ...
                    <div class="how-it-block1 bg-boxshadow" style=" min-height: 450px;">
                        ...
                        {{ csrf_field() }}
                            ...
                            <div class="form-group">
                                ...
                                <input id="FirstName" name="FirstName" type="text" placeholder="First Name" class="form-control input-md" onkeypress="return AllowAlphabet(event)" required="required">
                            </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input id="phoneNumber" name="phoneNumber" minlength="10" maxlength="10" type="text" onkeypress="return fnAllowNumeric(event)" placeholder="Mobile No." class="form-control input-md" required="required">
                            </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input id="RefferalCode" name="RefferalCode" value="0" type="text" placeholder="Refferal Code (If any)" class="form-control input-md" required="required">
                            </div>
                            </div>

                          <div class="col-md-4 col-sm-12 col-xs-12">
                                      <div class="form-group">
                                          <label class="control-label sr-only" for="Employment">Loan Tenure</label>
                            ...
                            <div class="col-md-4 col-sm-12 col-xs-12">
                            <div class="form-group">
                                <label class="control-label sr-only" for="LoanAmount">LoanAmount</label>
                                <input id="LoanAmount" name="LoanAmount" type="text" maxlength="6" onkeypress="return fnAllowNumeric(event)" placeholder="LoanAmount" class="form-control input-md" required="required">
                            </div>
                            </div>
