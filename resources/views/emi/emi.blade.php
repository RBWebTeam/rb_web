  ...
  <div class="row">
    <div class="col-sm-4 rw-hei" style="background-color:lavender;"><h3 class="emi-cal">EMI Calculator</h3>
      <div class="form-group">
       ...
       <input type="text" name="loanamount" class="form-control" id="loanamount" placeholder="Loan Amount" onkeypress="return fnAllowNumeric(event)"  value=""  onblur="myfun()" required="">
     </div>
     <div class="form-group">
      <label class="control-label" for="Interest Rate">Interest Rate:</label>
      <input type="text" name="loaninterest" step="0.01" min="0" class="form-control" id="loaninterest" placeholder="Interest" onkeypress="return fnAllowNumeric(event)"  value="" onblur="myfun()" required="">
    </div>
    <div class="form-group right-block">
     <label class="control-label" for="Loan Tenure">Loan Tenure:</label>
     <input type="text" name="loanterm" class="form-control" id="loanterm" placeholder="Loan Tenure" onkeypress="return fnAllowNumeric(event)" value="" onblur="myfun()" required="">
     <br>
     <div class="btn-group">
