...
<div class="fh5co-cta bt-bg" style="background:url(../images/bt-bg.jpg) no-repeat;">
		...
		<div class="container">
			<div class="col-md-12 text-center animate-box wht-brd pad fadeInUp animated">
				...
				<h3>To know how much you'll save,please enter your current home loan details.</h3>
			</div>
		</div>
		...
		<div class="container">
			<div class="col-md-12 text-center animate-box wht-brd pad fadeInUp animated">
				...
				<h3>Let's find out how much you can save!!</h3>
				<h3>To know how much you'll save,please enter your current personal loan details.</h3>
			</div>
		</div>
		<?php }else{?>
		<div class="container">
			<div class="col-md-12 text-center animate-box wht-brd pad fadeInUp animated">
				...
				<h3>Let's find out how much you can save!!</h3>
				<h3>To know how much you'll save,please enter your current loan against property details.</h3>
			</div>
		</div>
		<?php }?>
	</div>
