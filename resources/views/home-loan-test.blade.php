				...
				<h3>I am a
					...
					<div class="col-md-12 text-center animate-box cont" style="display: none;" id="q3">
						...
						<div class="text-center" style="display: none;" id="step_2_btn">
							...
							<a class="btn btn-primary btn-outline with-arrow animate-box product_name" id="no_co_app" data-toggle="modal" data-target="#login">No Co-Applicant<i class="icon-arrow-right"></i></a>
						</div>
					...
					<div class="text-center" style="display: none;" id="last_button">
						...
						<a class="btn btn-primary btn-outline with-arrow animate-box product_name" data-toggle="modal" data-target="#login">Submit<i class="icon-arrow-right"></i></a>
					</div>
			</div>		
				</form>
			<!-- POP Up code start -->
