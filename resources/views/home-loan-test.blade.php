				...
				<h3>I am a
					...
					<div class="col-md-12 text-center animate-box cont" style="display: none;" id="q3">
						...
						<div class="col-md-12 text-center animate-box cont" style="display: none" id="q6">
							<h3>Loan tenure
								<input type="tel" id="loan_tenure" name="loan_tenure"  onkeypress="changeText_new('loan_tenure','q7'); return fnAllowNumeric(event);" class="input-pad" placeholder="20" tabindex="1" maxlength="2" >
							</h3> 
						</div>
