            ...
            <div class="row">
                ...
                <div class="col-md-10 col-sm-6 col-xs-6 text-right">
                    <div class="header-action">
                        <a href="{{URL::to('contact-us')}}" class="btn btn-credit" style="padding:14px 12px">Free Credit Report</a>
      ...
      <div class="products">
        <div class="container">
            ...
            <br><br><br>
                ...
                <div class="col-md-4 col-sm-6   col-xs-12">
                    <div class="number-block text-white">
                        <a href="{{URL::to('loan-against-property')}}">
