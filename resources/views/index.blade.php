        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
			 <button type="button" class="close close-btn" data-dismiss="modal">×</button>
				<a href="{{URL::to('home-loan-transfer/home-loan')}}"><img src="{{URL::to('images/popup.jpg')}}" alt="Home Loan Transfer Advt" title="Home Loan Transfer Advt" class="img-responsive"/></a>
