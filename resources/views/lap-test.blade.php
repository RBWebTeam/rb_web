				...
				<h3>I am a
					...
					<div class="col-md-12 text-center animate-box cont" style="display: none;" id="q3">
						...
						<div class="col-md-12 text-center animate-box cont" style="display:none;" id="q5" >
							...
							<input type="text" class="search_city input-pad" id='city_name' name='city_name' onblur="changeTest_new('city_name','q_prop')" placeholder='your city' onchange="setSesson('city_name',this.value);">city</h3>
						...
						<div class="col-md-12 text-center animate-box cont1" style="display: none" id="date_birth">
							<h3>My date of birth is
								<input type="text" id="dob" name="dob" class="input-pad company-nm1 lastReporteddate" onchange="changeTest_new(this,'q9'),setSesson('dob',this.value);">
							</h3>
						</div>
