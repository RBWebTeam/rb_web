<!-- popup1 Start-->
  ...
  <div class="modal-dialog">
    ...
    <form id="car_type_form">
        <li><span><input type="radio" name="car_type"  value="New Car"  onclick="changeTest(this,'q3')" /></span>&nbsp; New Car</li>
      <li><span><input type="radio" name="car_type" value="Used Car"  onclick="changeTest(this,'q2')"/></span>&nbsp; Used Car</li>
 ...
 start-->
  ...
  <div class="modal-dialog">
    ...
    <form id="salary_via_form">
        <li><span><input type="radio" name="salary_via"  value="Cheque"  onclick="changeTest(this,'q10')"/></span>&nbsp; Cheque</li>
      <li><span><input type="radio" name="salary_via" value="NEFT" onclick="changeTest(this,'q10')"/></span>&nbsp;  An Account transfer(NEFT)</li>
     <li><span><input type="radio" name="salary_via" value="Cash" onclick="changeTest(this,'q10')"/></span>&nbsp;  Cash</li>
      </form>
      </ul>
  ...
  <div class="modal-dialog">
    ...
    <form id="stay_in_form">
      ...
      <li><span><input type="radio" name="stay_in" value="a rented house (with Family)" onclick="changeTest(this,'dob')"/></span>&nbsp;  a rented house (with Family)</li>
       <li><span><input type="radio" name="stay_in"  value="a rented house (with Friends)"  onclick="changeTest(this,'dob')"/></span>&nbsp; a rented house (with Friends)</li>
       <li><span><input type="radio" name="stay_in"  value="a rented house (Staying alone)"  onclick="changeTest(this,'dob')"/></span>&nbsp; a rented house (Staying alone)</li>
       <li><span><input type="radio" name="stay_in"  value="Paying guest"  onclick="changeTest(this,'dob')"/></span>&nbsp; Paying guest</li>
       <li><span><input type="radio" name="stay_in"  value=" Hostel"  onclick="changeTest(this,'dob')"/></span>&nbsp; Hostel</li>
       <li><span><input type="radio" name="stay_in"  value="y own house (Parent/Siblings)"  onclick="changeTest(this,'dob')"/></span>&nbsp; my own house (Parent/Siblings)</li>
       <li><span><input type="radio" name="stay_in"  value="Company provided house"  onclick="changeTest(this,'dob')"/></span>&nbsp; Company provided house</li>
