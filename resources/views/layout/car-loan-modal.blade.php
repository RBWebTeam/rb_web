<!-- popup1 Start-->
  ...
  <div class="modal-dialog">
    ...
    <ul>
    <form id="type_form">
        <li><span><input type="radio" name="type_car"  value="New Car"  onclick="car_f(this,'new_car');" /></span>&nbsp; New Car</li>
      <li><span><input type="radio" name="type_car" value="Used Car"  onclick="car_f(this,'used_car');"/></span>&nbsp; Used Car</li>
