             ...
             <div class="row">
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <div class="footer-logo">
                        <!-- Footer Logo -->
                        <img src="{{URL::to('images/footer-rupee-boss-logo.png')}}" alt="Rupee Boss"> 
                    </div>
                    <!-- /.Footer Logo -->
                </div>
...
<hr class="dark-line">
            <div class="row">
                ...
                <div class="col-md-12 col-xs-12 " style="padding:0px; z-index: 10000;position:relative;margin-bottom:10px;">
                                <a target="_blank" href="{{URL::to('https://play.google.com/store/apps/details?id=com.rupeeboss.rba')}}"><img src="{{URL::to('images/google_play.png')}}" width="150" alt="Rupee Boss"></a>
                    ...
                    <div class="widget-social mt10">
                        ...
                        <ul class="listnone " style=" margin: 0px 0px 10px 0px;">
                            ...
                            <li><a href="{{URL::to('contact-us')}}" style="font-weight: normal;">SME CAR LEASING</a></li>
                ...
                <h4><strong>Home Loan</strong></h4>
                    <div class="widget-footer mt10">
                        ...
                        <ul class="listnone">
                            ...
                            <li><a href="{{URL::to('loan-details/home-loan/pnb-housing')}}">PNB Housing Finance Ltd</a></li>
