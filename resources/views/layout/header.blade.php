...
<link href="{{URL::to('css/jquery-ui1.css')}}" rel="stylesheet">
       ...
       <div class="panel pan-log">
               ...
               <!-- </div> -->
                ...
                <form class="register-form displaynone"  name="registration_form" id="registration_form"   method="post" > 
                 {{ csrf_field() }}
                  ...
                  <div class="form-group">
                    <input type="text" name="name" id="name_register" tabindex="1" class="form-control" placeholder="Username" >
                      <span id="errorName" class="error-msg"></span>
                  </div>

                  <div class="form-group">
                    <input type="email" name="email" id="email_register" tabindex="1" class="form-control" placeholder="Email Address"  >
                    <span id="errorEmail"  class="error-msg" ></span>
                  </div>

                   <div class="form-group">
                    <input type="text" name="contact" id="contact_register" onkeypress="return fnAllowNumeric(event)" maxlength="10"  tabindex="1" class="form-control" placeholder="Mobile Number" >
         ...
         <div class="col-lg-12">
             <form class="forgot-form displaynone"  name="forgot_password_form" id="forgot_password_form"   method="post"  >
              {{ csrf_field() }}
                 <div class="form-group">
                    <input type="text" name="email" id="f_email" tabindex="1" class="form-control" placeholder="Email ID" >
