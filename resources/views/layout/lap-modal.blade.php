...
<!-- popup1 end-->
  ...
  <div class="modal-dialog">
    ...
    <form id="obligation_form">
        ...
        <li><span><input type="radio" name="obligation_type" value="yes" id="yes_id"  onclick="changeTest_new(this,'q4');"  onchange="SetSession_pop('exst_loan_detail',this.value);" /></span>&nbsp; <label for="yes_id"> YES</label></li>
      <li><span><input type="radio" name="obligation_type" value="no" id="no_id"  onclick="changeTest_new(this,'q5');" onchange="SetSession_pop('exst_loan_detail',this.value);"/></span>&nbsp;<label for="no_id"> NO</label> </li>
      </form>
      </ul>
