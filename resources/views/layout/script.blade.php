              ...
              // $('#hideshow').show(); 
                           ...
                           //  }else{
                            ...
                            //}
                             ...
                             var login= "<div id='refreshID' class='pull-right'><ul class='nav navbar-nav'><li class='dropdown'><a class='dropdown-toggle' data-toggle='dropdown' href='#'>"+msg.username+"<span class='caret'></span></a><ul class='dropdown-menu'><li><a id='googleLOG' href='{{URL::to('logout')}}'>Logout</a><a href='{{url('profile')}}'>My Profile</a><a href='{{URL::to('profile')}}'?credit-score'>My Credit Score</a><a href='{{url('profile')}}'?my-quotes'>My Quotes</a> <a href='{{url('track-application')}}'>Track Applications</a></li></ul></li></ul></div>";
