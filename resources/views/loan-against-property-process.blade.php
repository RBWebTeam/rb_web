...
<div class="container" id='elem'>
	  ...
	  <input type="hidden" id="product" name="product_name" value="Loan_Against_Property">
		<div class="liza col-md-8" id="step1ofagiansp" >
		   ...
		   <p class="text-center">Step 1 of 3</p>
			...
			<div class="col-md-12 text-center animate-box cont" id="typeofpro">
	            <h3>What is your type of property
				 <a href="#" class="svalue clr-blue pop_up" data-toggle="modal" data-target="#page1aginst" ><input type="text" style="color:000;" class="clr-blue" id="LAPpropertyType" name="HLpropertyType"  placeholder="Select" readonly></a>
				</h3> 
			</div>

         <div class="col-md-12 text-center animate-box cont"  style="display:none" id="agains_value" >
              <h3>What is your property value. 
			  <input type="text" id="pro_value" name="LAPpro_value" onkeyup="loanAgainstfn(this,'against3qe')" 
		 ...
		 <div class="col-md-12 text-center animate-box cont" style="display:none" id="livehere">
			...
			<input type="text" class="search_city input-pad" id='city_name' onkeyup="loanAgainstfn(this,'city_live')" name='LAPcity_name' placeholder='your city'>
          </div>
       
     
		<div class="col-md-12 text-center animate-box cont"  style="display:none" id="link_borrow" >
              <h3>How much would you like to borrow. 
			  <input type="text" id="lik_borrow" name="LAPlikeBorrow" onkeyup="loanAgainstfn(this,'lik_borrow')" 
       ...
       <div class="col-md-12 text-center animate-box cont"  style="display:none" id="borrow_it_for">
			 ...
			 <input type="text" id="borrow_year" name="LAPborrow_year" onkeyup="loanAgainstfn(this,'borrow_year')"
         ...
         <div class="col-md-12 text-center animate-box cont" style="display: none;"  id="curr_empl_y">
	            <h3>How are you currently employed
				 <a href="#" class="svalue clr-blue pop_up" data-toggle="modal" data-target="#curr_popup" ><input type="text" style="color:000;" class="clr-blue" id="curr_emp" name="LAPcurr_emp"  placeholder="Select" readonly></a>
				</h3> 
		</div>
			...
			<div class="col-md-12 text-center animate-box cont"  style="display:none;" id="TypProfession">
	            <h3>Select Profession type
				 <a href="#" class="svalue clr-blue pop_up" data-toggle="modal" data-target="#professaginst" ><input type="text" style="color:000;" class="clr-blue" id="proTypAgain" name="LAPprofessionType"  placeholder="Select" readonly></a>
				</h3> 
			</div>
	   ...
	   <!--- liza Step Two   - -->
		<div class="liza col-md-8"   	style="display:none;" id="step2ofagiansp">
          ...
          <div class="col-md-12 text-center animate-box cont"  id="currently_residing">
			...
			<input type="text" class="search_city input-pad" id='curr_residing' onkeyup="loanAgainstfn(this,'curr_residing')" name='LAPcurr_residing' placeholder='your city'>
               
		</div>

         <div class="col-md-12 text-center animate-box cont"  style="display:none" id="grossanual" >
              <h3>What is your gross annual income
			  <input type="text" id="anualainc" name="LAPannualIncom" onkeyup="loanAgainstfn(this,'anualincome')" 
			    onkeypress="return fnAllowNumeric(event)" class="input-pad" placeholder="1,00,000"  maxlength='10'  tabindex="1">
		     </h3>
		</div>
		 ...
		 <div class="col-md-12 text-center animate-box cont"  style="display:none" id="anulaTurnover" >
			  ...
			  <input type="text" id="annual_turnover" name="LAPannual_turnover" onkeyup="loanAgainstfn(this,'annual_turnovers')" 
			    onkeypress="return fnAllowNumeric(event)" class="input-pad" placeholder="1,00,000"  maxlength='10'  tabindex="1">
		     </h3>
		</div>
        ...
        <div class="col-md-12 text-center animate-box cont"  style="display:none" id="total_EMI" >
			  ...
			  <input type="text" id="totalEmi" name="LAPtotalEmi" onkeyup="loanAgainstfn(this,'totalEmi')" 
			    onkeypress="return fnAllowNumeric(event)" class="input-pad" placeholder="1,00,000"  maxlength='10'  tabindex="1">
		     </h3>
		</div>
			...
			<div class="col-md-12 text-center animate-box cont"  style="display:none;" id="bankAcount">
	            <h3>Select Your bank account is with
				 <a href="#" class="svalue clr-blue pop_up" data-toggle="modal" data-target="#bankAcountaginst" ><input type="text" style="color:000;" class="clr-blue" id="bankacount" name="LAPbankacount"  placeholder="Select" readonly></a>
				</h3> 
			</div>
			...
			<div class="col-md-12 text-center animate-box cont" id="want_co_borrower" style="display:none">
	            <h3>Do you want to add co-borrower
				 ...
				 <input type="text" style="color:000;" class="clr-blue" id="co_borrow_again" name="LAPaddBorrow"  placeholder="Select" readonly></a>
				</h3> 
			</div>
 ...
 <div class="col-md-12 text-center animate-box cont"   id="relationship_against">
	            <h3>What is your relationship with co-borrower
				 <a href="#" class="svalue clr-blue pop_up" data-toggle="modal" data-target="#against_co_borrw" ><input type="text" style="color:000;" class="clr-blue" id="releation_agai" name="LAPreleationBorrower"  placeholder="Select" readonly></a>
				</h3> 
			</div>
          ...
          <div class="col-md-12 text-center animate-box cont" style="display: none;"  id="employment_co_borrow">
				...
				<a href="#" class="svalue clr-blue pop_up" data-toggle="modal" data-target="#employment_aginst" ><input type="text" style="color:000;" class="clr-blue" id="emp_co_bor" name="LAPempTypeBorrower"  placeholder="Select" readonly></a>
				</h3> 
		    </div>
		   ...
		   <div class="col-md-12 text-center animate-box cont"  style="display:none" id="cobor_month" >
			 ...
			 <input type="text" id="co_borrwo" name="LAPco_borrwoIncome" onkeyup="loanAgainstfn(this,'co_borrwo')" 
			    onkeypress="return fnAllowNumeric(event)" class="input-pad" placeholder="1,00,000"  maxlength='10'  tabindex="1">
		     </h3>
		</div>
		...
		<div class="col-md-12 text-center animate-box cont"  style="display:none" id="co_borrow_EMI" >
			  ...
			  <input type="text" id="co_borrowemi" name="LAPco_borrowEmi" onkeyup="loanAgainstfn(this,'co_borrowemi')" 
			    onkeypress="return fnAllowNumeric(event)" class="input-pad" placeholder="1,00,000"  maxlength='10'  tabindex="1">
		     </h3>
		</div>
