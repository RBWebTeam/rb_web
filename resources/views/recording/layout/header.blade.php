...
<script type="application/ld+json">
 ...
 <style>
	...
	@media only screen and (max-width: 768px) {
		...
		#myModal111 .modal-dialog {width:auto !important;}
	}
 </style>
 </head>
	<body>
        ...
        <div class="container">
         <div class="col-md-8">
            <ul class="top-lnk">
                ...
                <li class="hidden-xs"><a href="{{URL::to('http://www.rupeeboss.com/elite/')}}">Elite</a></li>
                <li class="hidden-xs"><a href="{{URL::to('http://www.rupeeboss.com/mf/')}}">Mutual Funds</a></li>
				<li class="hidden-lg"><a href="{{URL::to('magic-link')}}">Magic Link </a></li>
				<li class="hidden-xs credit-score-btn"><a href="{{URL::to('http://www.rupeeboss.com/equifax-verification/')}}" class="btn-primary">My Credit Score</a></li>
