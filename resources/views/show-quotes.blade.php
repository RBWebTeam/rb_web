            ...
            <div class="table-responsive outer-brd">
               <form id="quote_form_{{$key}}">
                  ...
                  <table width="100%" border="1" class="tbl">
                     ...
                     <tr>
                        <td>
                           <input type="checkbox" name="checkbox" value="{{$q->Bank_Name}}"  class="{{$q->Bank_Id}}"  data-id="{{$q->Bank_Id}}"/>
                        </td>
                     ...
                     <tr>
                        ...
                        <td class="upper">
                           <!-- <a href="#">Know More</a>  --><button type="button" data-toggle="collapse" data-target="#{{$key}}"><span class="hidden-xs">Know</span> More</button>
                        </td>
