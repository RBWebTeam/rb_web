...
<?php $__currentLoopData = $quote_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $q): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?> 
...
<table width="100%" border="1" class="tbl">
  <tr>
    ...
    href="<?php echo e(URL::to('apply-lead-online')); ?>?appid=0&qoutid=<?php echo e($quote_id); ?>&BankId=<?php echo e($q->Bank_Id); ?>&product=<?php echo e($prod); ?>">Apply Online</a></td>
  </tr>
  <tr>
    <td>
    <input type="checkbox" name="checkbox" value="<?php echo e($q->Bank_Name); ?>"  class="<?php echo e($q->Bank_Id); ?>"  data-id="<?php echo e($q->Bank_Id); ?>"/></td>
    ...
    <input type="hidden" name="LoanRequired" class="LoanRequired" value="<?php echo e($q->LoanRequired); ?>">
   ...
   <input type="hidden" name="product" class="product" value="<?php echo e($product); ?>">
    ...
    <input type="hidden" name="url" class="url" value="<?php echo e(URL::to('apply-lead-online')); ?>?appid=0&qoutid=<?php echo e($quote_id); ?>&BankId=<?php echo e($q->Bank_Id); ?>&product=<?php echo e($prod); ?>">


    <td ><?php echo e($product); ?></td>
    <td ><?php echo e($q->roi); ?>%</td>
    <td ><?php echo e($q->LoanRequired); ?></td>
