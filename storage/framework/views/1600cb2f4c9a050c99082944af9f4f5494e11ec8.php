  ...
  <div class="row">
        <div class="col-md-12 bhoechie-tab-container">
           ...
           <li>Joining Fee Rs.750</li>
					 ...
					 <a href="<?php echo e(URL::to('credit-card-rbl')); ?>?card=1" class="btn btn-default btn-sm pull-left">APPLY NOW</a>
					</div>
                    </center>
                </div>
                <!-- train section -->
           ...
           <li>Joining Fee Rs.2000</li>
					 ...
					 <a href="<?php echo e(URL::to('credit-card-rbl')); ?>?card=2" class="btn btn-default btn-sm pull-left">APPLY NOW</a>
					</div>
                    </center>
                </div>
           ...
           <li>Joining Fee Rs.1000</li>
					 ...
					 <a href="<?php echo e(URL::to('credit-card-rbl')); ?>?card=3" class="btn btn-default btn-sm pull-left">APPLY NOW</a>
					</div>
                    </center>
                </div>
