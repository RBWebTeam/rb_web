<?php echo $__env->make('layout.header', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
 ...
 <div>
  ...
  <tr>
    ...
    ?>
    <td class="upper"><a href="<?php echo e(URL::to('apply-')); ?><?php echo e($product); ?>">Apply Online</a></td>
	<?php }else{ ?>
	<td class="upper"><a href="<?php echo e(URL::to('contact-us')); ?>">Apply Online</a></td>
	<?php } ?>
...
<!--     <td><input type="checkbox" name="cehckbox"/></td> -->
    ...
    <td><?php echo e($value->Max_Loan_Amt); ?></td> 
   <td><?php echo e($value->Min_Income); ?></td>
   <td><?php echo e($value->Min_Age); ?>-<?php echo e($value->Max_Age); ?></td>
   <td><?php echo e($value->Women_roi); ?></td>
   <td><?php echo e($value->MinCredit_Score); ?></td> 
   <td><?php echo e($value->Min_Tenure); ?>-<?php echo e($value->Max_Tenure); ?>Years</td> 
   <td><p>Salaried</p></td> 
