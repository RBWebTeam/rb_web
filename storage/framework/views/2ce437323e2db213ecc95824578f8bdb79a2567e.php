...
<div id="fh5co-hero">
  <img src="<?php echo e(URL::to('images/yesbank.png')); ?>" alt="Yes Bank Home Loan Banner" width="100%" title="Yes Bank Home Loan" class="img-responsive">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <h4><p id="modalerr"><h5 style="color: black">Your Yes Bank Home Loan Lead Id is <span id="yesbank"></span> .<h5></p></h4>
...
<script type="text/javascript">   
 ...
 $.ajax({ 
   url: "<?php echo e(URL::to('yesbank-hl-city-master')); ?>",
   method:"GET",
    ...
    if(! $('#Yes_Bank_HL_form').valid())
       {
        ...
        $.ajax({  
         type: "POST",  
         url: "<?php echo e(URL::to('yes-bank-home-loan-submit')); ?>",
