...
<img src="<?php echo e(URL::to('images/comfy_banner.png')); ?>" alt="Comfy Process" title="Comfy Process" class="img-responsive"/>
...
<p>While we cannot control what happens, we can keep you better prepared with Comfy at your rescue.</p>
 <a class="btn btn-success btn-outline with-arrow" href="<?php echo e(URL::to('/comfy-sales')); ?>">View Brochure
