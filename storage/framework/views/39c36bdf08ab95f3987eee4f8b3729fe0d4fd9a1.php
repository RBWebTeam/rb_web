   ...
   <div class="col-md-10 white-bg pad box-shadow">
      <div class="loan-head"><h6 class="text-center pad mrg-btm"><b>Server-side Developers</b></h6></div>
        <div class="col-sm-3 center-img">
            ...
            <img src="<?php echo e(URL::to('images/pratik_telang.jpg')); ?>" class="img-circle img-responsive" alt="Cinque Terre" width="173" height="173" >
        ...
        <div class="col-sm-3 center-img">
            <img src="<?php echo e(URL::to('images/manish_dixitji.jpg')); ?>" class="img-circle img-responsive" alt="Cinque Terre" width="173" height="173">
        ...
        <div class="col-sm-3 center-img">
            <img src="<?php echo e(URL::to('images/joel_jangam.jpg')); ?>" class="img-circle img-responsive" alt="Cinque Terre" width="173" height="173">
        ...
        <div class="col-sm-3 center-img">
            <img src="<?php echo e(URL::to('images/image_girl.jpg')); ?>" class="img-circle img-responsive" alt="Cinque Terre" width="173" height="173">
