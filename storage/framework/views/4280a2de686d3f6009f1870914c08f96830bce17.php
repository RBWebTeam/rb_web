<?php echo $__env->make('layout.header', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  ...
  <div class="carousel-inner" role="listbox">
    <div class="item active">
      <img src="<?php echo e(URL::to('images/01/car.jpg')); ?>" alt="Car Loan" title="Car Loan">
    </div>
		...
		<div class="container">
			...
			<div class="row">
				<div class="pricing pad">
					...
					<div class="col-md-4 animate-box">
					   <a  href="<?php echo e(URL::to('apply-car-loan')); ?>">
						<div class="price-box popular">
							...
							<a class="btn btn-primary btn-outline with-arrow" href="<?php echo e(URL::to('apply-car-loan')); ?>">Apply Online
