...
<style type="text/css">
  ...
  <hr>
    ...
    <?php $__currentLoopData = $data['loan_type']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
      
      <option value="<?php echo e($value); ?>"><?php echo str_replace("_"," ",$key);?></option>
    ...
    <option disabled selected>Select</option>
    <?php $__currentLoopData = $data['repayment_frequency']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
  ...
  <hr>
   ...
   <div class="col-md-8 form-padding"><input type="text" pattern="[789][0-9]{9}" maxlength="10" minlength="10"  name="mobile" id="mobile" class="form-control form-group" onkeypress="return fnAllowNumeric(event)" required /></div>
    ...
    <div class="col-md-8 form-padding sec">
     ...
     <option disabled selected>Select</option>
      <?php $__currentLoopData = $data['education']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
    ...
    <div class="col-md-8 form-padding sec">
      ...
      <option disabled selected>Select</option>
      <?php $__currentLoopData = $data['family_details']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
  ...
  <hr>
    ...
    <div class="col-md-8 form-padding sec">
     <select class="drop-arr" name="registration_detail" id="registration_detail" required>
       <option disabled selected>Select</option>
      <?php $__currentLoopData = $data['registration_details']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
    ...
    <div class="col-md-8 form-padding sec"  >
     <select class="drop-arr" name="partners_count" id="partners_count" required>
       <option disabled selected>Select</option>
      <?php $__currentLoopData = $data['partner_count']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
    ...
    <div class="col-md-8 form-padding sec"  >
     <select class="drop-arr" name="directors_count" id="directors_count" required>
       <option disabled selected>Select</option>
      <?php $__currentLoopData = $data['director_count']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
    ...
    <div class="col-md-8 form-padding sec"  >
     <select class="drop-arr" name="business_run_by" id="business_run_by" required>
       <option disabled selected>Select</option>
      <?php $__currentLoopData = $data['proprietorship_type']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
    ...
    <div class="col-md-8 form-padding sec">
      ...
      <option disabled selected>Select</option>
      <?php $__currentLoopData = $data['nature_of_business']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
    ...
    <div class="col-md-8 form-padding sec">
      ...
      <option disabled selected>Select</option>
      <?php $__currentLoopData = $data['online_sales_channels']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
    ...
    <div class="col-md-8 form-padding sec">
       ...
       <option disabled selected>Select</option>
      <?php $__currentLoopData = $data['turnover']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
    ...
    <div class="col-md-8 form-padding sec">
      <select class="drop-arr" name="business_premises" id="business_premises" required>
       <option disabled selected>Select</option>
      <?php $__currentLoopData = $data['ownership']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
    ...
    <div class="col-md-8 form-padding sec">
      <select class="drop-arr" name="selling_product" id="selling_product" required>
       <option disabled selected>Select</option>
      <?php $__currentLoopData = $data['product_sell']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
    ...
    <ul>
     ...
     <?php $__currentLoopData = $data['aggregated_ids']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
      <li class="pad"><input type="radio" name="online_ids" value="<?php echo e($value); ?>" onclick="showDiv('online_ids_<?php echo e($value); ?>')" /> <?php echo e(str_replace("_"," ",$key)); ?></li>
        <div class="col-sm-12" id="online_ids_<?php echo e($value); ?>" style="display: none;" class="extra">

          <?php $length=sizeof($data['aggregated_ids_credentials']->$value);
           for($i=0;$i<$length;$i++){ ?>
           <label class="col-sm-2"> <?php echo e(str_replace("_"," ",$data['aggregated_ids_credentials']->$value[$i])); ?>:</label>
           <input type="text" class="form-control form-group col-sm-10" name="online_ids_array[<?php echo e($value); ?>][<?php echo $data['aggregated_ids_credentials']->$value[$i]; ?>]" required />
    ...
    <input type="hidden" name="transaction_id" class="transaction_id">
        ...
        <div class="col-md-8 form-padding sec">
         <select class="drop-arr" name="institution"  required>
           <option disabled selected>Select</option>
          <?php $__currentLoopData = $data['institution']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
...
$("#upload_doc_submit").click(function(){
  ...
  var form_url="<?php echo e(URL::to('upload-tribe-doc')); ?>";
  $.ajax({
      url:form_url ,  
...
$("#submit_tribe_statement").click(function(){
  ...
  if(!$('#bank_statement_form').valid()){
   ...
   if(!check_file_ext('statement_file')){
    ...
    var form_url="<?php echo e(URL::to('upload-tribe-bank-statement')); ?>";
    $.ajax({
          url:form_url ,
...
$('#freeze_form').click(function(){
    ...
    $.ajax({  
             type: "POST",  
             url: "<?php echo e(URL::to('save-tribe-form')); ?>",
...
function tribe_doc_upload(id){
  ...
  $('#close_tribe_transaction').click(function(){
       var form_url="<?php echo e(URL::to('tribe-close-transaction')); ?>";
      $('#went_wrong_modal').modal('hide');
    $.ajax({
          url:form_url ,
    ...
    $('#abandon_tribe_application').click(function(){
      $('#went_wrong_modal').modal('hide');
        $.ajax({  
               type: "POST",  
               url: "<?php echo e(URL::to('abandon-tribe-application')); ?>",
               data : "_token=<?php echo csrf_token(); ?>",
               success: function(msg){
    ...
    $('#tribe_final_submit').click(function(){
     ...
     $.ajax({  
               type: "POST",  
               url: "<?php echo e(URL::to('tribe-final-submission')); ?>",
               data :"_token=<?php echo csrf_token(); ?>",
               success: function(msg){
...
function get_doc_fun(id){
  ...
  $('#went_wrong_modal').modal('hide');
    $.ajax({  
               type: "POST",  
               url: "<?php echo e(URL::to('get-tribe-doc')); ?>",
               data : "id="+new_id+"&_token=<?php echo csrf_token(); ?>",
               success: function(msg){
               // console.log(msg);
                if(msg.status){
...
function del_doc_fun(id,doc){
  ...
  $('#went_wrong_modal').modal('hide');
    $.ajax({  
               type: "POST",  
               url: "<?php echo e(URL::to('del-tribe-doc')); ?>",
               data : "id="+new_id+"&_token=<?php echo csrf_token(); ?>",
               success: function(msg){
               // console.log(msg);
                if(msg.status){
