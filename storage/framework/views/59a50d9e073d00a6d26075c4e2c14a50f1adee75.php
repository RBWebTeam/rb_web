...
<div class=" validate_id" style="color: red" >Please Fill All Inputs</div>
 ...
 <table width="100%" class="table-striped table-bordered" id="table_total">
  ...
  <div class="fix-pos">
    ...
    <!-- <a href="<?php echo e(url('new-working-capital')); ?>" class="btn btn-success aply-btn disblk ">Apply Now</a> -->
...
$("button").click(function(e){
   ...
   validation=formValidat(loanAmount,interest,loanTenure);
      ...
      $.ajax({  
             type: "POST",  
             url: "<?php echo e(URL::to('term-loan/calculate')); ?>",
             dataType:"json",
...
function ajax(_token,loanAmount_id,interest,loanTenurMonth,ID,paid){
    $.ajax({  
             type: "POST",  
             url: "<?php echo e(URL::to('Working-Capital/calculate')); ?>",
             dataType:"json",
