      ...
      <div class="products">
        <div class="container">
            ...
            <br><br><br>
                ...
                <div class="col-md-4 col-sm-6   col-xs-12">
                    <div class="number-block text-white">
                        <a href="<?php echo e(URL::to('car-loan')); ?>">
                        <div class="circle-3 circle11"><img src="images/business_loan.svg" alt="Business Loan" style="width:60px"><!--<i class="icon-calculator  icon-4x icon-white"></i>--></div>
                        <h3 class="text-black mb30" style="font-size: 17px;">Car Loan</h3>
                        </a>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6   col-xs-12">
                    <div class="number-block text-white">
                        ...
                        <h3 class="text-black mb30" style="font-size: 17px;">Loan Against Property</h3><br>
                        </a>
                    </div>
                </div>
                ...
                <div class="" id="service">
                    ...
                    <div class="col-md-02 col-sm-4 col-xs-6">
                        <div class="service-block-v5">
                            <a href="<?php echo e(URL::to('http://www.rupeeboss.com/elite/')); ?>" class="btn-2 btn-secondary btn-block" style="background-color: #000;">ELITE</a>
                        </div>
                    </div>

                    <div class="col-md-02 col-sm-4 col-xs-6">
                        <div class="service-block-v5">
                            <a href="<?php echo e(URL::to('express-loan')); ?>" class="btn-2 btn-secondary btn-block" style="background-color: #ed1c24;">EXPRESS LOAN</a>
                        </div>
                    </div>

                    <div class="col-md-02 col-sm-4 col-xs-6">
                        <div class="service-block-v5">
                            <a href="<?php echo e(URL::to('credit-card')); ?>" class="btn-2 btn-secondary btn-block" style="background-color: #000;">CREDITS CARDS</a>
                        </div>
                    </div>

                    <div class="col-md-02 col-sm-4 col-xs-6">
                        <div class="service-block-v5">
                            <a href="<?php echo e(URL::to('home-loan')); ?>" class="btn-2 btn-secondary btn-block" style="background-color: #ed1c24;">PM AWAS YOJANA</a>
                        </div>
                    </div>
