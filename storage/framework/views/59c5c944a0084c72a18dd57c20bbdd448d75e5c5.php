                ...
                <div class="" id="service">
                    ...
                    <div class="col-md-02 col-sm-4 col-xs-6">
                        <div class="service-block-v5">
                            <a href="#" class="btn-2 btn-secondary btn-block" style="background-color: #000;">ELITE</a>
                        </div>
                    </div>

                    <div class="col-md-02 col-sm-4 col-xs-6">
                        <div class="service-block-v5">
                            <a href="#" class="btn-2 btn-secondary btn-block" style="background-color: #ed1c24;">EXPRESS LOAN</a>
                        </div>
                    </div>

                    <div class="col-md-02 col-sm-4 col-xs-6">
                        <div class="service-block-v5">
                            <a href="#" class="btn-2 btn-secondary btn-block" style="background-color: #000;">CREDITS CARDS</a>
                        </div>
                    </div>

                    <div class="col-md-02 col-sm-4 col-xs-6">
                        <div class="service-block-v5">
                            <a href="#" class="btn-2 btn-secondary btn-block" style="background-color: #ed1c24;">PM AWAS YOJANA</a>
                        </div>
                    </div>
