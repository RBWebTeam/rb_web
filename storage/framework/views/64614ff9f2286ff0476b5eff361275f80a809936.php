  ...
  <?php echo e(csrf_field()); ?>
    ...
    <div id="hideview" class="text-center col-md-6">
          ...
          <div class="col-xs-6 form-padding">
             ...
             <div class="col-xs-6 form-padding">
                    <div>
                      <input type="text" name="CreditCardApplied" id="cc_applied" class="form-control inp-fld used" onkeypress="return AllowAlphabet(event)" value="<?php echo e($card); ?>" disabled="" >
                      <span class="highlight"></span><span class="bar"></span>
...
return false;
       ...
       if( $('#mobile').val()!='' &&  $('#pan').val()!=''){
        ...
        url:"<?php echo e(URL::to('rbl-credit-submit')); ?>",
