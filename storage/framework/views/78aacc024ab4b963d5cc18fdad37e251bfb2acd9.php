<?php echo $__env->make('layout.header', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    ...
    <!--- liza Step First   - -->
	    ...
	    <form name='personal_loan_process_form' id='personal_loan_process_form' action=<?php echo e(URL::to('loan-submit')); ?> method="POST">
...
<?php echo $__env->make('layout.business-loan-modal-test', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
