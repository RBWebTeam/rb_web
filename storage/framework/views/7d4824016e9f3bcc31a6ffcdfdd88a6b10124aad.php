<?php echo $__env->make('layout.header', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  ...
  <div class="carousel-inner" role="listbox">
    <div class="item active">
      <img src="<?php echo e(URL::to('images/01/personal.jpg')); ?>" alt="Personal Loan" title="Personal Loan">
    </div>
    ...
    <span class="sr-only">Next</span>
	   ...
	   <div class="form-in ">
				  ...
				  <div class="has-error error_p">
				    <div>
				      <input type="text" class="form-control" id="name" name="name" placeholder="Name" required />
				       <input type="hidden" class="form-control" id="product" value="<?php echo e($id->Product_Name); ?>" name="product"  />
				    </div>
				  </div>
			<div class="has-error error_p">
			...
			pattern="[789][0-9]{9}" required maxlength="10" minlength="10" placeholder="Mobile No." >
			  ...
			  <div class="centr-obj submit_button"> 
			...
			<div class="row">
				<div class="pricing pad">
					<div class="col-md-4 animate-box">
					    <a href="<?php echo e(URL::to('get-loan')); ?>/<?php echo e($id->Product_Id); ?>" >
					...
					<div class="col-md-4 animate-box">
					   <a href="<?php echo e(URL::to('/apply-personal-loan')); ?>" >
						<div class="price-box popular">
							...
							<a class="btn btn-primary btn-outline with-arrow" href="<?php echo e(URL::to('/new-personal-loan')); ?>">Apply Online
