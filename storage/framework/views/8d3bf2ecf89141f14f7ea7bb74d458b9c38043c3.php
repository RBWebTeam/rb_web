            ...
            <div class="col-md-12">
				...
				<h1 class=""><center>Calculators</center></h1>
                    ...
                    <div class="how-it-block hvr-float-shadow2" style="background-color: #f7f7f7; ">
                        ...
                        <a href="<?php echo e(URL::to('check-emi')); ?>" class="btn btn-default btn-sm" >View Now</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" style="padding-bottom: 20px">
                    <div class="how-it-block hvr-float-shadow2" style="background-color: #f7f7f7; ">
                        ...
                        <a href="<?php echo e(URL::to('personal-loan-calculator')); ?>" class="btn btn-default btn-sm" >View Now</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" style="padding-bottom: 20px">
                    <div class="how-it-block hvr-float-shadow2" style="background-color: #f7f7f7; ">
                        ...
                        <a href="<?php echo e(URL::to('home-loan-calculator')); ?>" class="btn btn-default btn-sm" >View Now</a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="how-it-block hvr-float-shadow2" style="background-color: #f7f7f7; ">
                        ...
                        <a href="<?php echo e(URL::to('business-loan-calculator')); ?>" class="btn btn-default btn-sm" >View Now</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" style="padding-bottom: 20px">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" style=" padding-bottom: 20px">
                    <div class="how-it-block hvr-float-shadow2" style="background-color: #f7f7f7;">
                        ...
                        <a href="<?php echo e(URL::to('coming-soon')); ?>" class="btn btn-default btn-sm" >View Now</a>
                        </div>
                    </div>
                </div>
