<?php echo $__env->make('layout.header', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
	...
	<aside id="fh5co-hero">
	<div class="col-md-12">
	<!-- <p class="text-left"><a href="<?php echo e(URL::to('/')); ?>">Home</a>/<?php echo e($id->Product_Name); ?></p> -->
  ...
  <div class="carousel-inner" role="listbox">
    <div class="item active">
      <img src="<?php echo e(URL::to('images/01/business.jpg')); ?>" alt="Business Loan" title="Business Loan">
    </div>
				  ...
				  <div class="has-error">
				    <div>
				      <input type="text" class="form-control" id="name" name="name" placeholder="Name" required />
				       <input type="hidden" class="form-control" id="product" value="business" name="product"  />
				    </div>
				  </div>
			<div class="has-error">
				...
				<div class="pricing pad">
					<div class="col-md-4 animate-box">
						...
						<div class="price-box popular">
							...
							<!-- <a class="btn btn-primary btn-outline with-arrow" href="<?php echo e(URL::to('get-loan')); ?>/<?php echo e($id->Product_Id); ?>" >Compare<i class="icon-arrow-right"></i></a>
 -->
							<a class="btn btn-primary btn-outline with-arrow" href="<?php echo e(URL::to('contact-us')); ?>" >Compare<i class="icon-arrow-right"></i></a>
					...
					<div class="col-md-4 animate-box">
					     <a href="<?php echo e(URL::to('check_emi')); ?>" >
						<div class="price-box popular">
							...
							<a class="btn btn-primary btn-outline with-arrow" href="<?php echo e(URL::to('check_emi')); ?>">Calculate EMI<i class="icon-arrow-right"></i></a>
						</div>
						</a>
					</div>
					
					<div class="col-md-4 animate-box">
					   <a href="<?php echo e(URL::to('apply-business-loan')); ?>" >
						<div class="price-box popular">
							...
							<a class="btn btn-primary btn-outline with-arrow" href="<?php echo e(URL::to('apply-business-loan')); ?>">Apply Online
