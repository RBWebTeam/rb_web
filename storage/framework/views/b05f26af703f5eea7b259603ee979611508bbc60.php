      ...
      if(! $('#application_form').valid())
       {
        ...
        {   
            $.ajax({  
             type: "POST",  
             url: "<?php echo e(URL::to('application-submit')); ?>",
             data : $('#application_form').serialize(),
             success: function(msg){
                  console.log(msg);
                if(msg==1){
                         if (product == 'Low Cost Housing Finance') {
                           window.location.href ="<?php echo e(URL::to('contact-us?CampaignName=GaneshChaturthi')); ?>";
                          } else if(product =='Credit sudhar'){
                             window.location.href ="<?php echo e(URL::to('contact-us?CampaignName=GaneshChaturthi')); ?>";
                          }else if(product== 'Early Salary') {
                            window.location.href ="<?php echo e(URL::to('early-salary?CampaignName=GaneshChaturthi')); ?>";
                          }else if(product =='Credit Card'){
                             window.location.href ="<?php echo e(URL::to('credit-card?CampaignName=GaneshChaturthi')); ?>";
                         }else if(product =='Balance Transfer'){
                            window.location.href ="<?php echo e(URL::to('magic-link?CampaignName=GaneshChaturthi')); ?>";
                        }else{
                          window.location.href ="<?php echo e(URL::to('apply-iifl-loan?CampaignName=GaneshChaturthi')); ?>";  
                        }
                    }else{
