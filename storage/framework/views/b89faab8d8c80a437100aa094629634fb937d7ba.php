...
<img src="<?php echo e(URL::to('images/9.png')); ?>" alt="Tribe Logo" class="img-responsive" />
 ...
 <h1 class="text-center loan-head">Smart Home Loan</h1>
...
<center><div class="type-cover"><span>PROPERTY TYPE</span></div></center>
	...
	<div class="col-xs-4 form-padding">
     <input type="text" class="form-input-new form-control" name="loan_amount" id="loan_amount" 
   placeholder="Loan Required" required onkeypress="return fnAllowNumeric(event)"  value="">
	</div>
	<div class="col-xs-4 form-padding">
