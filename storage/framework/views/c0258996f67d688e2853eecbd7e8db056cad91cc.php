<?php echo $__env->make('layout.header', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
	...
	<aside id="fh5co-hero">
	<div class="col-md-12">
	<!-- <p class="text-left"><a href="<?php echo e(URL::to('/')); ?>">Home</a>/Sme Loan</p> -->
...
<div class="carousel-inner" role="listbox">
    <div class="item active">
      <img src="<?php echo e(URL::to('images/01/sme.jpg')); ?>" alt="Small And Medium Enterprises Banner" title="Small And Medium Enterprises Banner">
    </div>
				  ...
				  <div class="has-error">
				    <div>
				      <input type="text" class="form-control" id="name" name="name" placeholder="Name" required />
				       <input type="hidden" class="form-control" id="product" value="sme" name="product"  />
				    </div>
				  </div>
			<div class="has-error">
		...
		<div class="container">
			...
			<div class="row">
				<div class="pricing pad">
					...
					<div class="col-md-4 animate-box">
					   <a href="<?php echo e(URL::to('apply-sme-loan')); ?>">
						<div class="price-box popular">
							...
							<a class="btn btn-primary btn-outline with-arrow" href="<?php echo e(URL::to('contact-us')); ?>">Apply Online
