<?php echo $__env->make('layout.header', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  ...
  <div class="carousel-inner" role="listbox">
    <div class="item active">
      <img src="<?php echo e(URL::to('images/01/home.jpg')); ?>" alt="Home Loan" title="Home Loan">
    </div>
  ...
  <a class="right carousel-control" href="#myCarousel" role="button" data-slide="next">
	...
	<div id="fh5co-pricing-section">
	  ...
	  <a class="btn btn-primary btn-outline with-arrow" href="<?php echo e(URL::to('get-loan')); ?>/<?php echo e($id->Product_Id); ?>">Compare<i class="icon-arrow-right"></i></a>
					...
					<div class="col-md-4 animate-box">
					    <a href="<?php echo e(URL::to('/apply-home-loan')); ?>" >
						<div class="price-box popular">
							...
							<a class="btn btn-primary btn-outline with-arrow" href="<?php echo e(URL::to('/new-home-loan')); ?>">Apply Online
