<?php echo $__env->make('layout.header', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  ...
  <div class="carousel-inner" role="listbox">
    <div class="item active">
      <img src="<?php echo e(URL::to('images/01/lap.jpg')); ?>" alt="Loan Against Property" title="Loan Against Property">
    </div>
		...
		<div class="container">
			...
			<div class="row">
				<div class="pricing pad">
					...
					<div class="col-md-4 animate-box">
					   <a href="<?php echo e(URL::to('/apply-loan-against-property')); ?>" >
						<div class="price-box popular">
							...
							<a class="btn btn-primary btn-outline with-arrow" href="<?php echo e(URL::to('/apply-loan-against-property')); ?>">Apply Online
