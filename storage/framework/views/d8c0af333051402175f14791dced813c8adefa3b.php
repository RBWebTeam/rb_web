								...
								<div class="row sec">
									<div class="form-group">
										...
										<div class="col-md-4">
											  ...
											  <?php $__currentLoopData = $state; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $state_name): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
				      						 <option value="<?php echo e($state_name->State_Code); ?>" >
				      						 	<span style="font-family: bold; "><?php echo e($state_name->State_Name); ?>
									...
									<div class="row sec">
										<div class="form-group">
											...
											<div class="col-md-4">
											  ...
											  <?php $__currentLoopData = $telephone; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tele): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
				      						 <option value="<?php echo e($tele->Telephone_Value); ?>" >
				      						 	<span style="font-family: bold; "><?php echo e($tele->Telephone_Name); ?>
