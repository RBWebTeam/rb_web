                    ...
                    <div class="wrapper-content bg-white pinside40">
                        <div class="section-faq" id="section-faq">
                            <div class="">
                                ...
                                <h1 class="">
                                <center>Kotak Personal Loan</center></h1>
                                </div>
                                </div>
              ...
              <form class="" id="Kotak_PL_form" role="form" method="POST" >
               <?php echo e(csrf_field()); ?>
                ...
                <div class="row">
                  <div class="form-group">
                    ...
                    <div class="col-md-4">
                                ...
                                <select class="form-control block drop-arr select-sty" name="IsExstCust" id="IsExstCust" required>
                                ...
                                <select class="form-control block drop-arr select-sty" name="Gender" id="Gender" required>
                                ...
                                <select class="form-control block drop-arr select-sty" name="Qualification" id="Qualification" required>
                ...
                <div class="row sec" style="display: none;"  id="section1">
                  <div class="form-group">
                    <center><h3 class="loan-head" >Office Details</h3></center>
                    <br>
                    <div class="col-md-4">
                                ...
                                <input  type="text" class="form-control" onkeypress="return fnAllowNumeric(event)" placeholder="Total Work Experience" name="TotWrkExp" id="TotWrkExp" required>
                                 ...
                                 <div class="col-md-4">
                                  ...
                                  <select class="form-control block drop-arr select-sty" name="PrefMailAdd" id="PrefMailAdd" required>
                ...
                <div class="row sec" style="display: none;"  id="section2">   
                  <div class="form-group">
                    <center><h3 class="loan-head" >Current Address</h3></center>
                    <br>
                  ...
                  <div class="form-group">
                    ...
                    <center><h3 class="loan-head" >Permanent Address</h3></center>
                    <br>
                    <div class="col-md-4">
                                          <!-- <span>Address 1</span> -->
                  ...
                  <div class="row sec" style="display: none;" id="section4">
                    <div class="form-group">
                      <center><h3 class="loan-head" >Financial Details</h3></center>
                      <br>
                  ...
                  <div class="col-md-12">Is any Co-Applicant added? :
                  ...
                  <div style="display: none;"  id="co_app_details" >
                              ...
                              <div class="col-md-4" >
                                        ...
                                        <select class="form-control block drop-arr select-sty" name="CoAppEmpType" 
