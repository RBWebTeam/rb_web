...
<form name="car_loan_process_form" id="car_loan_process_form" action="<?php echo e(URL::to('loan-submit')); ?>" method="POST" >
...
<input type="hidden" id="product" name="product_name" value="1">
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" data-parent="#accordion" href="#collapse1">Used Car Information <i class="icon-minus pull-right more-less"></i></a>
  ...
  <div class="col-md-12">
<center><div class="type-cover"><span>Used Car Type</span></div></center>
