                    ...
                    <?php echo e(csrf_field()); ?>
						   ...
						   <input type="hidden" name="empid" class="empid" value=" <?php echo Session::get('empid')?Session::get('empid'):'';?>">
                            ...
                            <div class="form-group">
                                                    ...
                                                    <select id="proprietor" name="proprietor" class="form-control">
                            ...
                            <div class="form-group">
                                <label class="control-label sr-only" for="emp_detail">Business Type</label>
                                                    ...
                                                    <select id="emp_detail" name="emp_detail" class="form-control">
                            ...
                            <div class="form-group">
                                ...
                                <input id="loan_amount" name="loan_amount" type="text" placeholder="Loan Amount" class="form-control input-md" minlength="6" maxlength="9"  onkeypress="return isNumberKey(event)"  required>
                            </div>
                            </div>
                            ...
                            <div class="col-md-4 col-sm-12 col-xs-12">
                             <div class="form-group">
                                ...
                                <input id="pan_no" name="pan_no" type="text" placeholder="Pan No." oninput="pan_card('pan_no')" class="form-control input-md" required="required">
                              <span id="pan_number"  style="display:none;color: red;font-size:10px;">Enter Valid Pan No.</span>
                             </div>
                             </div>
                            ...
                            <div class="col-md-4 col-sm-12 col-xs-12">
                             <div class="form-group">
													...
													<select class="form-control input-md"  name="loan_tenure" id="loan_tenure" required>
                             ...
                             <div class="form-group">
                                                    ...
                                                    <select class="form-control input-md"  name="exchange" id="exchange" required>
                            ...
                            <h4 >Company Financials</h4>
                             ...
                             <div class="form-group">
                                ...
                                <!-- <input id="date" type="date" placeholder="Date of Birth"> -->
                                <input id="income_tax_paid" name="income_tax_paid" type="text" placeholder="Income Tax Paid - Firm" class="form-control input-md" onkeypress="return isNumberKey(event)" required="required">
                             ...
                             <div class="form-group">
                                ...
                                <!-- <input id="date" type="date" placeholder="Date of Birth"> -->
                                <input id="turnover" name="turnover" type="text" placeholder="Turnover / Topline" class="form-control input-md" onkeypress="return isNumberKey(event)" required="required">
                             ...
                             <div class="form-group">
                                ...
                                <!-- <input id="date" type="date" placeholder="Date of Birth"> -->
                                <input id="profit_after_tax" name="profit_after_tax" type="text" placeholder="Profit After Tax" class="form-control input-md" onkeypress="return isNumberKey(event)" required="required">
                             ...
                             <div class="form-group">
                                ...
                                <!-- <input id="date" type="date" placeholder="Date of Birth"> -->
                                <input id="depreciation" name="depreciation" type="text" placeholder="Depreciation" class="form-control input-md" onkeypress="return isNumberKey(event)" required="required">
                             ...
                             <div class="form-group">
                                ...
                                <!-- <input id="date" type="date" placeholder="Date of Birth"> -->
                                <input id="partner_remuneration" name="partner_remuneration" type="text" placeholder="Partner Remuneration" class="form-control input-md" onkeypress="return isNumberKey(event)" required="required">
                             ...
                             <div class="form-group">
                                ...
                                <!-- <input id="date" type="date" placeholder="Date of Birth"> -->
                                <input step="0.01" min="0" name="interest_paid" id="interest_paid" onkeypress="return isNumberKey(event)"  type="text" placeholder="Interest Paid On Loan" class="form-control input-md" required="required">
                             ...
                             <div class="form-group">
                                ...
                                <!-- <input id="date" type="date" placeholder="Date of Birth"> -->
                                <input id="existing_emi" name="existing_emi" type="text" placeholder="Existing All EMI" class="form-control input-md" onkeypress="return isNumberKey(event)" required="required">
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12">
                             ...
                             <div class="form-group">
                                ...
                                <!-- <input id="date" type="date" placeholder="Date of Birth"> -->
                                <input id="emi" name="emi" type="text" placeholder="EMI" class="form-control input-md" required="required">
                              ...
                              <div class="col-md-6 col-sm-12 col-xs-12">
                             <div class="form-group">
                                <label class="control-label sr-only" for="emi">Select Loan</label>
                             ...
                             <div class="form-group">
                                ...
                                <!-- <input id="date" type="date" placeholder="Date of Birth"> -->
                                <input id="no_of_emi_paid" name="no_of_emi_paid" type="text" placeholder="No. of EMI Paid" class="form-control input-md"  onkeypress="return isNumberKey(event)" minlength="2" maxlength="2" required="required">
...
<!-- 
 ...
 -->
                                     ...
                                     <div class="valid_ID"></div>
                                                ...
                                                <a class="btn btn-default btn-sm" id="product_ID">Get Best Quotes</a>
     ...
     <div class="border brd-for" id="mi_id">
       ...
       <div class="col-md-6 col-xs-12">
         ...
         <div class="col-md-6 col-xs-12">
                                    <br>
         <button type="button" class="btn btn-default btn-sm block call_rm"  id="call_rm" name="call_rm" data-toggle="modal" data-target="#Modal" title="Call For RM(Single Day Process)">Call Manager</button>
