<?php echo $__env->make('layout.header', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  ...
  <div class="col-md-12">
        ...
        <div class="col-md-4">
            <div class="desc">
              <a href="<?php echo e(url('credit-card-compare/hdfc')); ?>">  <img src="images/hdfc_credit-crd.jpg" alt="HDFC Credit Cards" title="HDFC Credit Cards" class="img-responsive box-shadow"/></a>
            </div>
        </div>
   </div>
        </div> 
